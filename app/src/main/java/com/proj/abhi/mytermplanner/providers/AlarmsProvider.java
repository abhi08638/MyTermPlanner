...
public class AlarmsProvider extends ContentProvider{
    ...
    private static final String AUTHORITY = "com.proj.abhi.alarmsprovider";
    ...
    public Uri insert(Uri uri, ContentValues values) {
        long id = database.insert(Constants.Tables.TABLE_PERSIST_ALARM,
                null, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        return database.delete(Constants.Tables.TABLE_PERSIST_ALARM, selection, selectionArgs);
    }

    @Override
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        return database.update(Constants.Tables.TABLE_PERSIST_ALARM,
