...
public class CourseActivityOld extends GenericActivityOld
        implements NavigationView.OnNavigationItemSelectedListener, LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    private CursorAdapter profsCursorAdapter = new ContactsCursorAdapter(this,null,0);
    private CursorAdapter profsCursorExcludeAdapter = new ContactsCursorAdapter(this,null,0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.hasExtra(Constants.CURRENT_URI)){
            ...
            currentUri = Uri.parse(CoursesProviderOld.CONTENT_URI+"/"+0);
        }
        ...
        assessmentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(getCurrentUriId()>0){
                    Intent intent = new Intent(CourseActivityOld.this, AssessmentActivity.class);
        ...
        profList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(getCurrentUriId()>0){
                    Intent intent = new Intent(CourseActivityOld.this, ContactActivity.class);
                    Uri uri = Uri.parse(ContactsProvider.CONTENT_URI + "/" + id);
                    intent.putExtra(Constants.CURRENT_URI, uri);
                    startActivityForResult(intent,0);
                }
            }
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int button) {
                                if (button == DialogInterface.BUTTON_POSITIVE) {
                                    ...
                                    getContentResolver().delete(CoursesContactsProvider.CONTENT_URI,where,null);
                                    Bundle b = new Bundle();
                                    b.putString("contentUri", CoursesContactsProvider.CONTENT_URI.toString());
                                    getLoaderManager().restartLoader(Constants.CursorLoaderIds.COURSE_PROF_ID_INCLUDE,b,CourseActivityOld.this);
                                    Snackbar.make(mCoordinatorLayout, R.string.deleted_prof, Snackbar.LENGTH_LONG).show();
                                }
                            }
                        };

                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(CourseActivityOld.this);
    ...
    protected void save() throws Exception{
        ...
        try{
            ...
            if(Utils.isValidDate(startDate.getText().toString())) {
                values.put(Constants.Course.COURSE_START_DATE, Utils.getDbDateTime(startDate.getText().toString()));
            }
            //end date must be valid
            if(Utils.isValidDate(endDate.getText().toString())) {
                values.put(Constants.Course.COURSE_END_DATE, Utils.getDbDateTime(endDate.getText().toString()));
            }
                        ...
                        public void onClick(DialogInterface dialog, int button) {
                            if (button == DialogInterface.BUTTON_POSITIVE) {
                                if(assessmentList.getAdapter().getCount()==0){
                                    ...
                                    new AlarmTask(CourseActivityOld.this,null, null).cancelAlarms(cancelAlarmsWhere);
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int button) {
                        if (button == DialogInterface.BUTTON_POSITIVE) {
                            ...
                            getContentResolver().insert(CoursesContactsProvider.CONTENT_URI,values);
                            Bundle b = new Bundle();
                            b.putString("contentUri", CoursesContactsProvider.CONTENT_URI.toString());
                            getLoaderManager().restartLoader(Constants.CursorLoaderIds.COURSE_PROF_ID_INCLUDE,b,CourseActivityOld.this);
                            ...
                            Intent intent = new Intent(CourseActivityOld.this, ContactActivity.class);
                            Uri uri = Uri.parse(ContactsProvider.CONTENT_URI + "/" + 0);
                            intent.putExtra(Constants.CURRENT_URI, uri);
                            startActivityForResult(intent,0);
                        }
                    }
    ...
    protected void refreshPage(int id){
        currentUri = Uri.parse(CoursesProviderOld.CONTENT_URI+"/"+id);
        if(id>0){
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        if(bundle!=null){
            ...
            }else if(uri.equals(CoursesContactsProvider.CONTENT_URI)){
                //raw query
            ...
            return new CursorLoader(this, CoursesProviderOld.CONTENT_URI,
                    cols,where,null,null);
        }
    }
